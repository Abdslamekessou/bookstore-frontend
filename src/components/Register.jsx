    ...
    <div className='h-[calc(100vh-120px)] flex justify-center items-center'>
        <div className='w-full max-w-sm mx-auto bg-white shadow-md rounded px-8 pb-6 pt-8 mb-4'> 
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <div>
                    <button className="bg-blue-500 hover:bg-blue-700 text-white text-bold py-2 px-8 rounded focus:outline-none">Register</button>
                </div>
                <p className="align-baseline font-medium mt-4">Have an account ? Please
